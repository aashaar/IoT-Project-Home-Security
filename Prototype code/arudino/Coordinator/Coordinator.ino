...
void activateLight()
{
  ...
  //checksum - sum of everything that is non-zero after 'low part of length'
  long checksum = 0x17 + 0x13 + 0xA2 + 0x41 + 0x08 + 0x09 + 0xDD + 0xFF + 0xFE + 0x02 +0x44 + 0x33 +0x5;
  checksum = 0xFF - (checksum & 0xFF);
  Serial.write(checksum); //write checksum to Serial
}
...
void deactivateLight()
{
  ...
  //checksum - sum of everything that is non-zero after 'low part of length'
  long checksum = 0x17 + 0x13 + 0xA2 + 0x41 + 0x08 + 0x09 + 0xDD + 0xFF + 0xFE + 0x02 +0x44 + 0x33 + 0x4;
  checksum = 0xFF - (checksum & 0xFF);
  Serial.write(checksum); //write checksum to Serial
}
