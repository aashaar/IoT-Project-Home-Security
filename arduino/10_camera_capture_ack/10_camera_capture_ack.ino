...
void loop() 
{
  if(Serial.available()>0)
  {
    ...
    {    
        ...
        flag = false;
        Serial.println("F"); // codeword for Failed (negative ack) to be sent to the coordinator.
      ...
      //Serial.println("Snap in 10 secs...");
      //delay(10000);
      ...
      time = millis() - time;
      Serial.println("done!");
      Serial.println("picture captured & stored in SD card");
